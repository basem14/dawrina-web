...
const RootStyle = styled.footer`
  ...
  color:var(--bussiness-white-color) !important;
  margin-top:15rem;
direction:rtl;
                    ...
                    <Col md={6}  >
                        <Stack direction="horizontal" gap={3}>
                            <div className="Footer-Logo">
                                <StaticImage
                                    src="../../images/Mobile/Group 127.png"
                                    alt="logo"
                                    placeholder="blurred"
                                    width={82}
                                    height={75}
                                />
                                <div style={{ background: '#858261', height: '30px', alignSelf: 'center', width: '2px' }} className="vr"></div>
                                <Typography
                                    variant="h5"
