    ...
    <>
      ...
      >
        <Offcanvas.Header>
         ...
         <div>
          <Media at='sm'>
          <h1 style={{color:'var(--text-dark)',fontSize:'3rem',marginRight:'3rem'}}>القائمة الرئيسية</h1>
          </Media>
...
<IconBotton
        ...
        <Offcanvas.Body>
          <MobileNavList>
            {NAV_ITEMS.map((item) => (
              <MobileNavListItem onClick={handleClose}  key={item.id} to={item.href}>
                {item.label}
              </MobileNavListItem>
            ))}

<div className="w-100 d-flex justify-content-center align-items-center mt-5 gap-3">
<ButtonLink onClick={handleClose} to="/business">شورى للاعمال</ButtonLink>
<ButtonLink onClick={handleClose}  href="https://portal.shwra.sa" target="_blank">شورى للمحامين</ButtonLink>
...
<Media at='sm'>
            ...
            >
             ...
             {DeviceType !== -1 && ButtonContainer[DeviceType].dbBtn}
