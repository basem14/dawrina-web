...
const FooterLinks = () => {
  ...
  >
    <StaticImage
      src="../../images/contact/Icon_PlayStore.png"
      alt="app-image"
      placeholder="blurred"
      objectFit='contain'
   ...
   <div className='Footer-LinkText'>
    <span style={{fontSize:'1.33rem',fontWeight:'800'}}>Google Play</span>
...
>
  ...
  <StaticImage
      src="../../images/contact/Icon_Apple.png"
      alt="app-image"
      placeholder="blurred"
      objectFit='contain'
      style={{ width:'30px',height:'40px' }}
...
>
<StaticImage
      src="../../images/contact/Icon_Huwaei.png"
      alt="app-image"
      placeholder="blurred"
      objectFit='contain'
      style={{ width:'30px', height:'40px' }}
